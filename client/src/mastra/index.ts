...
export const mastra = new Mastra({
  ...
  agents: { weatherAgent,shellAgent,twitterAgent,emailAgent,nextjsAgent,docsAgent,phishingDetectorAgent,normalAgent,browserAgent,webScraperAgent,youtubeAgent,MusicMoodAgent,imageAgent },
  logger: createLogger({
    name: 'Mastra',
    level: 'info',
  }),
